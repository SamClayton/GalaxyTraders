...
// Define the subdocument schema first, so that's its available for the main document schema
Settings = new SimpleSchema({
    ...
    upgradeCost:            {type: Number, label: "Upgrade Cost", label: "", defaultValue: 500},
    upgradeFactor:          {type: Number, label: "Upgrade Factor", defaultValue: 1.0767},
    planetUpgradeFactor:    {type: Number, label: "Plant Upgrade Factor", defaultValue: 1.0671},
